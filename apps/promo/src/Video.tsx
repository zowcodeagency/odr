...
export const Video = ({ tagline, contact, email }: VideoProps) => (
  <AbsoluteFill>
    ...
    <Sequence from={startOf("close")} durationInFrames={dur("close")}><Close durationInFrames={dur("close")} tagline={tagline} contact={contact} email={email} /></Sequence>
